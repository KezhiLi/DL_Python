...
model = Sequential()  
model.add(LSTM(7, 25, return_sequences=True))
model.add(LSTM(25, 25, return_sequences=True))  
model.add(Dropout(0.2))   
model.add(LSTM(25, 25, return_sequences=True))  
model.add(Dropout(0.2))     
model.add(LSTM(25, 25, return_sequences=False))  
model.add(Dropout(0.2))   
model.add(Dense(25, 7))  
...
# save model weights
model.save_weights('./DLWeights/nas207-1/experimentBackup/from pc207-7/!worm_videos/copied_from_pc207-8/Andre/03-03-11/multiFile_weights_7-25-25-25-25-7_1000ep.h5')                    
## save to csv
