...
import h5py
import numpy as np
with h5py.File('./data/eig_para_full2.hdf5', 'r') as fid:
...
# save to csv
np.savetxt("./data/eig_MulLayer_predicted_full2.csv", predicted, delimiter=",")
np.savetxt("./data/eig_MulLayer_y_test_full2.csv", y_test, delimiter=",")
...
# save to csv
np.savetxt("./data/eig_MulLayer_generated_full2.csv", eig_generated1, delimiter=",")     
