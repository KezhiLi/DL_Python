...
6*200*200*6 layers, more epochs, n_prev = 30
1st, 2nd dimensions were doubled before input
@author: kezhili
"""
...
import h5py
import numpy as np
with h5py.File('./data/eig_para_full24.hdf5', 'r') as fid:
...
## save to csv
#np.savetxt("./data/eig_MulLayer_predicted_full24.csv", predicted, delimiter=",")
#np.savetxt("./data/eig_MulLayer_y_test_full24.csv", y_test, delimiter=",")
...
## save to csv
#np.savetxt("./data/eig_MulLayer_generated_full24.csv", eig_generated1, delimiter=",")     

print time.time() - t0         
## save model weights
#model.save_weights('./data/eig_MulLayer_generated_full24.h5')      