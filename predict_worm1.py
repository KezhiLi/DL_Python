...
import h5py
import numpy as np
with h5py.File('./data/angle_vec.hdf5', 'r') as fid:
...
model.fit(X_train, y_train, batch_size=450, nb_epoch=5, validation_split=0.05)  
...
# save to csv
np.savetxt("./data/predicted.csv", predicted, delimiter=",")
...
# save to csv
np.savetxt("./data/generated.csv", generated, delimiter=",")                