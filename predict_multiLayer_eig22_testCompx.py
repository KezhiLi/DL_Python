...
model = Sequential()  
model.add(LSTM(7, 20, return_sequences=True))  
model.add(LSTM(20, 20, return_sequences=False))  
#model.add(LSTM(7, 40, return_sequences=False))  
model.add(Dropout(0.2))  
model.add(Dense(20, 7))  
model.add(Activation("linear"))  
model.compile(loss="mean_squared_error", optimizer="rmsprop")  
...
# save to csv
#np.savetxt("./data/eig_MulLayer_generated_full23.csv", eig_generated1, delimiter=",")     
