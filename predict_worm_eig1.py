...
import h5py
import numpy as np
with h5py.File('./data/eig_para1.hdf5', 'r') as fid:
...
# save to csv
np.savetxt("./data/eig_predicted1.csv", predicted, delimiter=",")
np.savetxt("./data/eig_y_test1.csv", y_test, delimiter=",")
...
# save to csv
np.savetxt("./data/eig_generated1.csv", eig_generated1, delimiter=",")                