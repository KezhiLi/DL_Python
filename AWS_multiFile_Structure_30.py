...
file_no = 0
root = './DLWeights/eig_catagory_Straits/wild-isolate_strain/'
...
# save model weights
model.save_weights('./DLWeights/eig_catagory_Straits/wild-isolate_strain/multiFile_wild-isolate_7-260-260-260-260-7_600ep.h5')                    
## save to csv
