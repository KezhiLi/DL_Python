...
import h5py
import numpy as np
with h5py.File('./data/angle_vec2.hdf5', 'r') as fid:
    angle_vec2 = fid['/angle_vec2'][:]     
   
columns = ['a', 'b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r']    
data = pd.DataFrame(angle_vec2, columns =  columns)    
...
# save to csv
np.savetxt("./data/predicted2.csv", predicted, delimiter=",")
np.savetxt("./data/y_test2.csv", y_test, delimiter=",")
...
# save to csv
np.savetxt("./data/generated2.csv", generated2, delimiter=",")                