...
# save to csv
np.savetxt(file_name+"_predicted-hid4.csv", predicted, delimiter=",")
np.savetxt(file_name+"_y_test-hid4.csv", y_test, delimiter=",")
...
# save to csv
np.savetxt(file_name+"_generated-hid4.csv", eig_generated1, delimiter=",")     

print time.time() - t0         
# save model weights
model.save_weights(file_name+"_generated-hid4.h5")      