...
# change the folder accordingly here
write_csv_loc = 'C:/Users/kezhili/Documents/Python Scripts/data/FromAWS/N2/features_real.csv'
feature_loc = "Z:/DLWeights/eig_catagory_Straits/N2/"
...
#for root, dirs, files in os.walk("C:/Users/kezhili/Documents/Python Scripts/data/FromAWS/7-200-200-200-200-7/08-03-11/600epochs/no_noise/"):
for root, dirs, files in os.walk(feature_loc):
    for feat_file in files:        
        if feat_file.endswith("_features.hdf5"):
            ...
            # write the mean of features to a .csv file    
                #with open('C:/Kezhi/MyCode!!!/Simulated_Worm/features_real2.csv', 'wb') as csvfile:
                with open(write_csv_loc,'wb') as csvfile:
                # write the column names
                    ...
                    csvwriter.writerow({
                        ...
                        feature_field[0]: np.nanmedian(all_feats[feature_field[0]]), 
                        feature_field[1]: np.nanmedian(all_feats[feature_field[1]]),
                        feature_field[2]: np.nanmedian(all_feats[feature_field[2]]),
                        feature_field[3]: np.nanmedian(all_feats[feature_field[3]]),
                        feature_field[4]: np.nanmedian(all_feats[feature_field[4]]),
                        feature_field[5]: np.nanmedian(all_feats[feature_field[5]]),
                        feature_field[6]: np.nanmedian(all_feats[feature_field[6]]),
                        feature_field[7]: np.nanmedian(all_feats[feature_field[7]]),
                        feature_field[8]: np.nanmedian(all_feats[feature_field[8]]),
                        feature_field[9]: np.nanmedian(all_feats[feature_field[9]]),
                        feature_field[10]: np.nanmedian(all_feats[feature_field[10]]),
                        feature_field[11]: np.nanmedian(all_feats[feature_field[11]]),
                        feature_field[12]: np.nanmedian(all_feats[feature_field[12]]),
                        feature_field[13]: np.nanmedian(all_feats[feature_field[13]]),
                        feature_field[14]: np.nanmedian(all_feats[feature_field[14]]),
                        feature_field[15]: np.nanmedian(all_feats[feature_field[15]]),
                        feature_field[16]: np.nanmedian(all_feats[feature_field[16]]),
                        feature_field[17]: np.nanmedian(all_feats[feature_field[17]]),
                        feature_field[18]: np.nanmedian(all_feats[feature_field[18]]),
                        feature_field[19]: np.nanmedian(all_feats[feature_field[19]]),
                        feature_field[20]: np.nanmedian(all_feats[feature_field[20]]),
                        feature_field[21]: np.nanmedian(all_feats[feature_field[21]]),
                        feature_field[22]: np.nanmedian(all_feats[feature_field[22]]),
                        feature_field[23]: np.nanmedian(all_feats[feature_field[23]]),
                        feature_field[24]: np.nanmedian(all_feats[feature_field[24]]),
                        feature_field[25]: np.nanmedian(all_feats[feature_field[25]])
                    })
            else:
                #with open('C:/Kezhi/MyCode!!!/Simulated_Worm/features_real2.csv', 'ab') as csvfile:
                with open(write_csv_loc,'ab') as csvfile:
                    csvwriter = csv.DictWriter(csvfile, fieldnames=['file_name']+feature_field)
                    csvwriter.writerow({
                        # write features in each column
                        'file_name' : feat_file[:-14],
