...
# save model weights
model.save_weights('./DLWeights/nas207-1/experimentBackup/from pc207-7/!worm_videos/copied_from_pc207-8/Andre/03-03-11/multiFile_weights_7-200-200-200-7_600ep.h5')                    
# save to csv
