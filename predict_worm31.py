...
import h5py
import numpy as np
with h5py.File('./data/angle_vec3-2.hdf5', 'r') as fid:
...
# save to csv
np.savetxt("./data/predicted3(18-650-650-18).csv", predicted, delimiter=",")
np.savetxt("./data/y_test3(18-650-650-18).csv", y_test, delimiter=",")
...
# save to csv
np.savetxt("./data/generated3(18-650-650-18).csv", generated3, delimiter=",")                