        ...
        try:
            ...
            ('ED3017' in name)or ('LSJ1' in name)): 
                ...
                for ii in range(7):
                    ...
                    model_name = './nips/'+stain+'/multiFile_'+stain+'_7-260-260-260-260-7_600ep.h5' 
...
with open('./nips/table_20170511.csv', 'wb') as f: 
    writer = csv.writer(f)
    writer.writerows(table)
with open('./nips/table_full_20170511.csv', 'wb') as ff: 
