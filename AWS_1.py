...
with h5py.File('./DLWeights/nas207-1/experimentBackup/from pc207-7/!worm_videos/copied_from_pc207-8/Andre/03-03-11/247 JU438 on food L_2011_03_03__11_18___3___1_eig.hdf5', 'r') as fid:
    eig_coef = fid['/eig_coef'][:]  
...
# save to csv
np.savetxt("./DLWeights/nas207-1/experimentBackup/from pc207-7/!worm_videos/copied_from_pc207-8/Andre/03-03-11/generated.csv", eig_generated1, delimiter=",")     

print time.time() - t0         
# save model weights
model.save_weights('./DLWeights/nas207-1/experimentBackup/from pc207-7/!worm_videos/copied_from_pc207-8/Andre/03-03-11/weights.h5')      